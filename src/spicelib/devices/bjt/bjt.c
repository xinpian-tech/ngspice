...
IFparm BJTmPTable[] = { /* model parameters */
 ...
 IOPA("cbcp",BJT_MOD_CBCP, IF_REAL, "External base-collector constant capacitance"),
 IOPA("cbep",BJT_MOD_CBEP, IF_REAL, "External base-emitter constant capacitance"),
 IOPA("ccsp",BJT_MOD_CCSP, IF_REAL, "External collector/base-substrate constant capacitance"),
 ...
 IOP("gap1", BJT_MOD_GAP1, IF_REAL, "First bandgap temperature coefficient"),
 IOP("gap2", BJT_MOD_GAP2, IF_REAL, "Second bandgap temperature coefficient"),
 ...
 IOPR("bex",  BJT_MOD_XRCI,  IF_REAL, "Temperature exponent of RCI"),
 IOP("d",     BJT_MOD_XD,    IF_REAL, "Temperature exponent of VO"),
 IOPR("bexv", BJT_MOD_XD,    IF_REAL, "Temperature exponent of VO"),
